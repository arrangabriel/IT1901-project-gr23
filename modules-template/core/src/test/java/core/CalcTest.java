...
public class CalcTest {
    ...
    private static void checkCalc(Entry calc, double... operands) {
    ...
    public void testCalc() {
        checkCalc(new Entry());
        checkCalc(new Entry(1.0), 1.0);
        checkCalc(new Entry(3.14, 1.0), 1.0, 3.14);
    }
    ...
    public void testPeekOperand() {
        Entry calc = new Entry(1.0, 3.14);
        Assertions.assertEquals(3.14, calc.peekOperand());
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Entry().peekOperand());
    }
    ...
    public void testPopOperand_emptyStack() {
        Assertions.assertThrows(IllegalStateException.class, () -> new Entry().popOperand());
    }

    @Test
    public void testPerformOperation1() {
        Entry calc = new Entry(1.0);
    ...
    public void testPerformOperation1_emptyOperandStack() {
        Assertions.assertThrows(IllegalStateException.class, () -> new Entry().performOperation(n -> -n));
    }


    @Test
    public void testPerformOperation2() {
        Entry calc = new Entry(1.0, 3.0);
    ...
    public void testPerformOperation2_lessThanTwoOperands() {
        Assertions.assertThrows(IllegalStateException.class, () -> new Entry(1.0).performOperation((n1, n2) -> n1 - n2));
        Assertions.assertThrows(IllegalStateException.class, () -> new Entry().performOperation((n1, n2) -> n1 - n2));
    }
    ...
    public void testSwap_lessThanTwoOperands() {
        Assertions.assertThrows(IllegalStateException.class, () -> new Entry(1.0).swap());
        Assertions.assertThrows(IllegalStateException.class, () -> new Entry().swap());
    }
    ...
    public void testDup_emptyOperandStack() {
        Assertions.assertThrows(IllegalStateException.class, () -> new Entry().dup());
    }
}
